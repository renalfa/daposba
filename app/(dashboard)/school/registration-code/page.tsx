...
import {columns, RegistrationCodeRow} from "./_components/registration-code.column";

export function getMockRegistrationCodes(): RegistrationCodeRow[] {
...
export default async function SchoolRegistrationCodePage() {
    const data = getMockRegistrationCodes();

    return (
        <main className="container mx-auto p-6 space-y-6">
            <div className="flex items-center justify-between">
                <h1 className="text-2xl font-bold">Management Kode Registrasi Sekolah</h1>
