            ...
            <Card>
                ...
                <CardContent>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-10">
                        ...
                        <div className="grid grid-cols-12 gap-4">
                            <div className="col-span-12 lg:col-span-3">
                                ...
                                <p className="text-xs text-muted-foreground">
                                    Berikut adalah informasi identitas sekolah.
                                </p>
                            </div>
                        ...
                        <div className="grid grid-cols-12 gap-4">
                            <div className="col-span-12 lg:col-span-3">
                                <h3 className="text-sm font-semibold">Alamat Sekolah</h3>
                                <p className="text-xs text-muted-foreground">
                                    Berikut adalah informasi alamat sekolah.
                                </p>
                            </div>
                            <div className="grid gap-4 md:grid-cols-2 col-span-12 lg:col-span-9">
                                <FormField
                        ...
                        <div className="grid grid-cols-12 gap-4">
                            <div className="col-span-12 lg:col-span-3">
                                ...
                                <p className="text-xs text-muted-foreground">
                                    Berikut adalah informasi legal dan kepemilikan sekolah.
                                </p>
                            </div>
                            <div className="grid gap-4 md:grid-cols-2 col-span-12 lg:col-span-9">
                                <FormField
                        ...
                        <div className="grid grid-cols-12 gap-4">
                            <div className="col-span-12 lg:col-span-3">
                                ...
                                <p className="text-xs text-muted-foreground">
                                    Berikut adalah informasi sarana dan prasarana sekolah.
                                </p>
                            </div>
                            <div className="grid gap-4 md:grid-cols-2 col-span-12 lg:col-span-9">
                                <FormField
                        ...
                        <div className="grid grid-cols-12 gap-4">
                            <div className="col-span-12 lg:col-span-3">
                                <h3 className="text-sm font-semibold">Rekening Sekolah</h3>
                                <p className="text-xs text-muted-foreground">
                                    Berikut adalah informasi rekening sekolah.
                                </p>
                            </div>
